    ...
    (tr:class:name-table-property
     (internal
      #`(class-internal
         ...
         (#:public        #,@(append (get-names #'untyped:public)
                                     (get-names #'untyped:public-final)))
         (#:override      #,@(append (get-names #'untyped:override)
                                     (get-names #'untyped:override-final)))
         (#:final         #,@(append (get-names #'untyped:public-final)
                                     (get-names #'untyped:public-override)
                                     (get-names #'untyped:public-augment)))
         ...
         (#:augment       #,@(append (get-names #'untyped:augment)
                                     (get-names #'untyped:augment-final)))
  ...
  (define (do-make-locals-table clauses private-field-names)
    (define (get-names kind)
      (clauses->names (λ (clause)
                        (free-identifier=? (clause-kind clause) kind))
                      clauses))
    (define public-names        (append (get-names #'untyped:public)
                                        (get-names #'untyped:public-final)))
    (define override-names      (append (get-names #'untyped:override)
                                        (get-names #'untyped:override-final)))
